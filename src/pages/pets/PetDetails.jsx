...
import { FaHeart, FaRegHeart, FaArrowLeft, FaPaw, FaCalendarAlt, FaTag, FaCheckCircle, FaExclamationCircle } from "react-icons/fa";
              ...
              <div className="space-y-5">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    {pet.name} is a wonderful {pet.breed} looking for a loving family. 
                    At {pet.age} year(s) old, they're ready to bring joy and companionship 
                    to your home. Give {pet.name} the loving home they deserve!
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-orange-700 mt-1">
                        All our pets are health-checked and ready for their new homes. 
                        Adoption includes initial vaccinations and health certificate.
                      </p>
                    </div>
                  </div>
                </div>
